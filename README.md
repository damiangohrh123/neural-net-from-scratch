...
This project implements a neural network **completely from scratch** in Python, without using high-level frameworks like TensorFlow or PyTorch.  
It is designed to demonstrate how neural networks work at the **node and weight level**, with manual forward propagation, backpropagation, and weight updates.

## Motivation
It’s a hands-on way to truly understand the magic behind machine learning.
...
- Loss calculation (MSE / optional Cross-Entropy)  
- Training loop
...
We solve for the two possible scenarios based on the indices:  
    ...
    - Final derivative will look like this:  
...
<div align="center">
    <img src="images/gradient_matrix.png" width="600">
...
Forward Propagation: Input batch → NeuralNetwork.forward
...
Error Gradient Initialization: Loss.gradient
...
Backpropagation: NeuralNetwork.backward
...
Figure 6: MNIST testing dataset confusion matrix example [4]
9.3 Loss Monitoring
...
12. Reference
MIT Introduction to Deep Learning | 6.S191 [1]
CS231n Deep Learning for Computer Vision [2]
MNIST(hand written digit) Classification Using Neural Network(Step by Step) From Scratch | by Koushik Ahmed Kushal | Medium [3]
(PDF) The Misclassification Likelihood Matrix: Some Classes Are More Likely To Be Misclassified Than Others [4]
13. Appendix
